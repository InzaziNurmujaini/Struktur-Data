...
# Memuat data dari file CSV (ganti 'your_data.csv' dengan nama file sesuai)
...
for column in df.columns:
    ...
    # Melakukan uji Kolmogrov-Smirnov satu sampel
    statistic, p_value = kstest(sample_data, 'norm')

    # Menampilkan hasil
    print(f"Variabel: '{column}'")
    print("  Statistik KS:", statistic)
